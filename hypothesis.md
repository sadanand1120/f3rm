...
- 2026-03-18: Cut CLIP startup cost by parallelizing worker construction. The official `measure` baseline spent `extract.worker_init_s=23.898187` before meaningful extraction work began, while `extract.worker_warmup_s=0.319939` was negligible. Startup is a real target; warmup is not.
